package app.aaps.plugins.sync.wtShared
...
import app.aaps.plugins.sync.databinding.WtClientLogItemBinding
...
class WTClientFragment : DaggerFragment(), MenuProvider, PluginFragment {
    ...
    private var _binding: WtClientFragmentBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View =
        WtClientFragmentBinding.inflate(inflater, container, false).also {
            _binding = it
    ...
    private inner class RecyclerViewAdapter(private var logList: List<EventNSClientNewLog>) : RecyclerView.Adapter<RecyclerViewAdapter.WtClientLogViewHolder>() {

        override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): WtClientLogViewHolder =
            WtClientLogViewHolder(LayoutInflater.from(viewGroup.context).inflate(R.layout.wt_client_log_item, viewGroup, false))

        override fun onBindViewHolder(holder: WtClientLogViewHolder, position: Int) {
            holder.binding.logText.text = HtmlHelper.fromHtml(logList[position].toPreparedHtml().toString())
        }

        override fun getItemCount() = logList.size

        inner class WtClientLogViewHolder(view: View) : RecyclerView.ViewHolder(view) {

            val binding = WtClientLogItemBinding.bind(view)
        }
    }
}